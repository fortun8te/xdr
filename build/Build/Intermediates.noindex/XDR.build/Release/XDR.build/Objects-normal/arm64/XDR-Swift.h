...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="XDR",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS_NAMED("GetBrightnessCommand")
@interface GetBrightnessCommand : NSScriptCommand
...
SWIFT_CLASS_NAMED("SetBrightnessCommand")
@interface SetBrightnessCommand : NSScriptCommand
- (id _Nullable)performDefaultImplementation SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)initWithCommandDescription:(NSScriptCommandDescription * _Nonnull)commandDef OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS_NAMED("ToggleXDRCommand")
@interface ToggleXDRCommand : NSScriptCommand
- (id _Nullable)performDefaultImplementation SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)initWithCommandDescription:(NSScriptCommandDescription * _Nonnull)commandDef OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC3XDR14XDRAppDelegate")
@interface XDRAppDelegate : NSObject <NSApplicationDelegate>
